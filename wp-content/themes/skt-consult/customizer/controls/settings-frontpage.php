...
// Slide Font Typography And Colors
	...
	$wp_customize->add_setting('complete[slide_title1]', array(
		'type' => 'option',
		'default'	=> __('<small>We are Expert in</small>Business <span style="color: #6330ee;">Advice</span>','complete'),
	...
	$wp_customize->add_setting('complete[slide_desc1]', array(
		'type' => 'option',
		'default'	=> __('Mauris vel consequat felis. Curabitur id rutrum neque, ut vulputate est. Integer consectetur sed nisi et viverra. Duis in nulla erat.','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	...
	$wp_customize->add_setting('complete[slide_btn1]', array(
		'type' => 'option',
		'default'	=> __('GET STARTED','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
