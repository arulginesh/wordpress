<?php 
/**
 * The Custom Style for SKT Consulting
 *
...
.skt-footer-wave .skt-footer-wave-color{fill: <?php echo $complete['footer_color_id']; ?>;}
...
/*COPYRIGHT COLORS*/
#copyright{border-color: <?php echo $complete['copyright_bg_color']; ?>;}
