<?php
/**
 * The MAIN FUNCTIONS FILE for SKT Consulting
 *
...
function skt_complete_import_files() {
  return array(
    array(
      'import_file_name'             => 'Import SKT Consulting Demo',
...
define('SKT_THEME_DOC', 'http://sktthemesdemo.net/documentation/consulting-pro-documentation/');